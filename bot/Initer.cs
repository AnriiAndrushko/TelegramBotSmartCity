namespace bot
{
    public static class Initer
    {
        public static List<string> photos = new List<string>(){
            ...
            "https://www.seekpng.com/png/detail/940-9408213_refresh-icon-png-icon-png-refresh-button.png",
            "https://img.freepik.com/free-photo/pensive-man-with-question-marks-background_1134-620.jpg",
